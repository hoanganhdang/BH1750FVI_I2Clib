# BH1750FVI_I2Clib
**This BH1750FVI library is modified to use an Arduino I2C Master Library, which is as more 
flexibility, higher throughput and in some functions up to 40% reduction in code size compared 
to Wire (build-in) Library. Infact, it avoids infinite loop because of lost connection to slave devices**
